...
class ReportModel(BaseModel):
    ...
    risk: Optional[str] = Field(default=None, description="Potential risks or caveats.")
    next_steps: Optional[List[str]] = Field(default=None, description="Recommended next steps if hired.")
